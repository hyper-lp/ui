...
export function SectionCard({
    ...
    return (
        <div
            className={cn(
                'flex flex-col rounded-xl border border-default/5 bg-default/[0.01] p-3 transition-all duration-300 ease-in-out hover:border-solid hover:border-default/50',
